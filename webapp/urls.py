...
urlpatterns = [
    ...
    path('tree/<int:tree_pk>/<int:pk>/', views.PersonDetailView.as_view(), name='person_detail'),
    path('tree/<int:tree_pk>/delete/<int:person_pk>/<int:name_pk>/', views.delete_person, name="delete_person"),
